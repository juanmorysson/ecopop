                      ...
                      SizedBox(
                        ...
                        child: Card(
                          child: ListTile(
                              ...
                              subtitle: Text(comp != null
                                  ? "Esécies: " +
                                      comp.especie_a.toString() +
                                      " X " +
                                      comp.especie_b.toString()
                                  : "")),
                        ),
                      ),
                    ],
                    ...
                    child: Row(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Text(comp.especie_a.toString(),
                              style: TextStyle(fontWeight: FontWeight.bold)),
                        ),
                        SizedBox(
                          width: MediaQuery.of(context).size.width * 0.22,
                          child: Text(comp.especie_b.toString(),
                              style: TextStyle(fontWeight: FontWeight.bold)),
                        ),
                        SizedBox(
                          width: MediaQuery.of(context).size.width * 0.22,
